...
- $1_{ij}^{obj}$는 grid cell내에 class가 존재한다는 것을 의미하고 존재하면 $1_{ij}^{noobj}$
- $1_{ij}^{obj}$ 는 grid cell내에 class가 존재한다는 것을 의미하고 존재하면 $1$, 아니면 $1_{ij}^{noobj}$
- $1_{ij}^{obj}$ 는 grid cell내에 class가 존재한다는 것을 의미하고 존재하면 $1$, 아니면 $0$인 $1_{ij}^{noobj}$으로
